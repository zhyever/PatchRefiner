...
train_cfg=dict(max_epochs=36, val_interval=4, save_checkpoint_interval=36, log_interval=100, train_log_img_interval=500, val_log_img_interval=30, val_type='epoch_base', eval_start=0)
