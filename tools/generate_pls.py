...
def main():
    ...
    tester.generate_pl(args.cai_mode, process_num=args.process_num, image_raw_shape=image_raw_shape, patch_split_num=patch_split_num, count_thr=args.count_thr)
